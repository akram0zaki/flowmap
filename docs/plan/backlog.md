...
| ✅  | M2-COM-5  | Multi-team / multi-quarter footprint editing        |  M   | M2-MAP-1  | Drag onto another team adds a placement, Alt moves it; split across quarters; primary-footprint invariant enforced     |
